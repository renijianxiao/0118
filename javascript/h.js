(function() {
	var h = {},
		mt = {},
		c = {
			id: "7f78a821324600a0f059acdb24cf0937",
			dm: ["feiniu.com", "clk.gentags.net", "imp.gentags.net"],
	...
	var r = void 0,
		...
		w = !1;
	mt.h = {};
	mt.h.U = /msie (\d+\.\d+)/i.test(navigator.userAgent);
	mt.h.Fa = /msie (\d+\.\d+)/i.test(navigator.userAgent) ? document.documentMode || +RegExp.$1 : r;
	mt.h.cookieEnabled = navigator.cookieEnabled;
	mt.h.javaEnabled = navigator.javaEnabled();
	mt.h.language = navigator.language || navigator.browserLanguage || navigator.systemLanguage || navigator.userLanguage || "";
	mt.h.Ia = (window.screen.width || 0) + "x" + (window.screen.height || 0);
	mt.h.colorDepth = window.screen.colorDepth || 0;
	mt.cookie = {};
	mt.cookie.set = function(a, b, f) {
		var d;
		f.I && (d = new Date, d.setTime(d.getTime() + f.I));
		document.cookie = a + "=" + b + (f.domain ? "; domain=" + f.domain : "") + (f.path ? "; path=" + f.path : "") + (d ? "; expires=" + d.toGMTString() : "") + (f.Va ? "; secure" : "")
	};
	...
	(mt.m.X = function() {
		...
		(function() {
			if(!f)
				if(f = s, "complete" === document.readyState) a.B = s;
				...
				default:
					...
					if(d instanceof Array) {
						var g = ["["],
							f = d.length,
							n, e, k;
						for(e = 0; e < f; e++) switch(k = d[e], typeof k) {
							case "undefined":
							case "function":
							case "unknown":
								break;
							default:
								n && g.push(","), g.push(mt.j.stringify(k)), n = 1
						}
						g.push("]");
						return g.join("")
					}
	...
	mt.localStorage.set = function(a, b, f) {
		...
		try {
			window.localStorage ? (b = d.getTime() + "|" + b, window.localStorage.setItem(a, b)) : mt.localStorage.G() && (mt.localStorage.f.expires = d.toUTCString(), mt.localStorage.f.load(document.location.hostname), mt.localStorage.f.setAttribute(a, b), mt.localStorage.f.save(document.location.hostname))
		} catch(g) {}
	};
	...
	mt.url.S = function(a) {
		return(a = mt.url.va(a)) ? a.replace(/:\d+$/, "") : a
	};
	...
	h.s = {
		...
		C: A() || "https:" === document.location.protocol ? "https:" : "http:",
		Ta: 0,
		ia: 6E5,
		ka: 10,
		Q: 1024,
		ha: 1,
		r: 2147483647,
		$: "cc cf ci ck cl cm cp cu cw ds ep et fl ja ln lo lt nv rnd si st su v cv lv api u tt".split(" ")
	};
	(function() {
		var a = {
			l: {},
			...
			w: function(a, f) {
				this.l[a] = this.l[a] || [];
				for(var d = this.l[a].length, g = 0; g < d; g++) this.l[a][g](f)
			}
		};
		return h.z = a
	})();
	...
	(function() {
		var a = mt.m,
			...
			l = {
				aa: function() {
					c.ctrk && (b.c(document, "mouseup", l.ga()), b.c(window, "unload", function() {
						l.D()
				...
				ga: function() {
					return function(a) {
						a = l.ta(a);
						if("" !== a) {
							var b = (d.C + "//" + d.N + "?" + h.b.Y().replace(/ep=[^&]*/, "ep=" + encodeURIComponent("[" + a + "]"))).length;
							b + (d.r + "").length > d.Q || (b + encodeURIComponent(g.join(",") + (g.length ? "," : "")).length + (d.r + "").length > d.Q && l.D(), g.push(a), (g.length >= d.ka || /t:a/.test(a)) && l.D())
						}
					}
				},
				ta: function(b) {
					...
					f.U ? (e = Math.max(document.documentElement.scrollTop, document.body.scrollTop), k = Math.max(document.documentElement.scrollLeft, document.body.scrollLeft), k = b.clientX + k, e = b.clientY + e) : (k = b.pageX, e = b.pageY);
					...
					return k = (b = "a" == e.tagName.toLowerCase() ?
						e : a.sa(e)) ? k + ("t:a,u:" + encodeURIComponent(b.href) + "}") : k + "t:b}"
				},
				D: function() {
	...
	(function() {
		...
		function b() {
			...
			if((!n || !k) && e && m) u = s, p = +new Date;
			else if(n && k && (!e || !m)) u = w, q += +new Date - p;
			n = e;
			k = m;
			y = setTimeout(b, 100)
		}
	...
	(function() {
		...
		var f = mt.lang,
			...
			e = {
				...
				pa: function() {
					if(0 < e.p.length)
						for(var a = 0, b = e.p.length; a < b; a++) e.M(e.p[a]);
					e.p = t
				},
				M: function(a) {
					var b = a[0];
				...
				_setAutoPageview: function(a) {
					if(1 < a.length && (a = a[1], w === a || s === a)) e.e |= 2, h.b.T = a
				},
				_trackPageview: function(a) {
					if(1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
						...
						h.b.a.et = 0;
						h.b.a.ep = "";
						h.b.K ? (h.b.a.nv = 0, h.b.a.st =
							4) : h.b.K = s;
						var b = h.b.a.u,
							d = h.b.a.su;
						h.b.a.u = g.protocol + "//" + document.location.host + a[1];
						e.V || (h.b.a.su = document.location.href);
						h.b.g();
						h.b.a.u = b;
						h.b.a.su = d
					}
				...
				_trackEvent: function(a) {
					2 < a.length && (e.e |= 8, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 4, h.b.a.ep = b(a[1]) + "*" + b(a[2]) + (a[3] ? "*" + b(a[3]) : "") + (a[4] ? "*" + b(a[4]) : ""), h.b.g())
				},
				...
				_setReferrerOverride: function(a) {
					1 < a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? g.protocol + "//" + window.location.host + a[1] : a[1], e.V = s)
				},
				_trackOrder: function(b) {
					b = b[1];
					f.d(b, "Object") && (a(b), e.e |= 16, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 94, h.b.a.ep = d.stringify(b), h.b.g())
				},
				_trackMobConv: function(a) {
					if(a = {
							...
							callback: 5,
							share: 6
						}[a[1]]) e.e |= 32, h.b.a.et = 93, h.b.a.ep = a, h.b.g()
				},
				_trackRTPageview: function(b) {
					b = b[1];
					f.d(b, "Object") && (a(b), b = d.stringify(b), 512 >= encodeURIComponent(b).length && (e.e |= 64, h.b.a.rt = b))
				},
					...
					if(f.d(b, "Object")) {
						...
						if(900 >= l) m.call(this, b);
							...
							for(var l = Math.ceil(l / 900), p = "block|" + Math.round(Math.random() *
									g.r).toString(16) + "|" + l + "|", q = [], u = 0; u < l; u++) q.push(u), q.push(b.substring(900 * u, 900 * u + 900)), m.call(this, p + q.join("|")), q = []
					}
				},
	...
	(function() {
		function a() {
			"undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = s, this.a = {}, this.T = s, this.K = w, this.init())
		}
		var b = mt.url,
			f = mt.Z,
			d = mt.P,
		...
		a.prototype = {
			...
			A: function(a) {
				for(var d = 0; d < c.dm.length; d++)
					if(-1 <
						c.dm[d].indexOf("/")) {
						if(this.W(a, c.dm[d])) return s
					} else {
						var f = b.S(a);
						if(f && this.L(f, c.dm[d])) return s
					}
				return w
			},
			J: function() {
			...
			R: function() {
				for(var a = 0, b = c.dm.length; a < b; a++) {
					var d = c.dm[a];
					if(-1 < d.indexOf("/") && this.W(document.location.href, d)) return d.replace(/^[^\/]+(\/.*)/, "$1") + "/"
				}
				return "/"
			},
			xa: function() {
				if(!document.referrer) return m.k - m.o > c.vdur ? 1 : 4;
				var a =
					w;
				this.A(document.referrer) && this.A(document.location.href) ? a = s : (a = b.S(document.referrer), a = this.L(a || "", document.location.hostname));
				return a ? m.k - m.o > c.vdur ? 1 : 4 : 3
			},
			getData: function(a) {
				try {
			...
			La: function() {
				var a, b, d, f, e;
				m.o = this.getData("Hm_lpvt_" +
					c.id) || 0;
				13 === m.o.length && (m.o = Math.round(m.o / 1E3));
				b = this.xa();
				a = 4 !== b ? 1 : 0;
				if(d = this.getData("Hm_lvt_" + c.id)) {
					f = d.split(",");
					for(e = f.length - 1; 0 <= e; e--) 13 === f[e].length && (f[e] = "" + Math.round(f[e] / 1E3));
					for(; 2592E3 < m.k - f[0];) f.shift();
					e = 4 > f.length ? 2 : 3;
					for(1 === a && f.push(m.k); 4 < f.length;) f.shift();
					d = f.join(",");
					f = f[f.length - 1]
				} else d = m.k, f = "", e = 1;
			...
			Y: function() {
				for(var a = [], b = this.a.et, d = 0, f = m.$.length; d < f; d++) {
					var e = m.$[d],
						g = this.a[e];
			...
			Ma: function() {
				...
				this.a.cm = b.i(a, m.Ca) || "";
				this.a.cp = b.i(a, m.Da) || "";
				this.a.cw = b.i(a, m.Ba) || "";
				this.a.ci = b.i(a, m.za) || "";
				this.a.cf = b.i(a, m.Ea) || "";
				this.a.cu = b.i(a, m.Aa) || ""
			},
			init: function() {
				try {
					this.Ma(),
						0 === this.a.nv ? this.Ka() : this.O(".*"), h.b = this, this.fa(), v.w("pv-b"), this.Ja()
				} catch(a) {
					var b = [];
					b.push("si=" + c.id);
			...
			Ja: function() {
				...
				this.T ? (this.K = s, this.a.et = 0, this.a.ep = "", this.g(a)) : a()
			},
			g: function(a) {
				var b = this;
			...
			fa: function() {
				var a = document.location.hash.substring(1),
					d = RegExp(c.id),
					f = -1 < document.referrer.indexOf(m.da),
					e = b.i(a, "jn"),
					g = /^heatlink$|^select$/.test(e);
				a && (d.test(a) && f && g) && (this.a.rnd = Math.round(Math.random() * m.r), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", m.protocol + "//" + c.js + e + ".js?" + this.a.rnd), e = document.getElementsByTagName("script")[0],
			...
			Ka: function() {
				...
				if(b)
					for(var b = b.split(","), d = function(b) {
							f.log(m.C + "//" + decodeURIComponent(b), function(b) {
								a.O(b)
							})
			...
			if(window.performance && performance.timing && "undefined" !== typeof h.b) {
				...
				var e = function() {
					...
					var k = a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || [],
						u = t;
					b = t;
					if("www.baidu.com" === k[2] || "m.baidu.com" === k[2]) u = f.i(a, "qid"), b = f.i(a, "click_t");
					a = u;
					e.qid = a != t ? a : "";
	...
	(function() {
		var a = mt.h,
			...
			f = mt.event,
			d = mt.j;
		if("undefined" !== typeof h.b && (c.med || (!a.U || 7 < a.Fa) && c.cvcc)) {
			var g, l, n, e, k = function(a) {
					if(a.item) {
			...
			if(c.med) l = "/zoosnet", g = "swt", n = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, e = {
				click: function() {
					for(var a = [], b = k(document.getElementsByTagName("a")), b = [].concat.apply(b, k(document.getElementsByTagName("area"))), b = [].concat.apply(b, k(document.getElementsByTagName("img"))), d, f, e = 0, g = b.length; e < g; e++) d = b[e], f = d.getAttribute("onclick"),
				...
				e = {
					click: function() {
						for(var a = [], b = k(document.getElementsByTagName("a")), b = [].concat.apply(b, k(document.getElementsByTagName("area"))), b = [].concat.apply(b, k(document.getElementsByTagName("img"))), d, e, f, g = 0, l = b.length; g < l; g++) d = b[g], n !== r ? (e = d.getAttribute("onclick"), f = d.getAttribute("href"), p ? (d = d.getAttribute("id"), (n.test(e) || n.test(f) || p.test(d)) &&
	...
	(function() {
		...
		if("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
			var g = {
				ba: function() {
					for(var b = c.cvcf.length, d, e = 0; e < b; e++)(d = a.ra(decodeURIComponent(c.cvcf[e]))) && f.c(d, "click", g.na())
				},
				na: function() {
					return function() {
						h.b.a.et = 86;
